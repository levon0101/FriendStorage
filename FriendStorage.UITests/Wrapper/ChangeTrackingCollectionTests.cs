...
namespace FriendStorage.UITests.Wrapper
{
    ...
    public class ChangeTrackingCollectionTests
    {
        ...
        public void Initialize()
        {
            ...
            {
                new FriendEmailWrapper(new FriendEmail{Email="levon.ecs@gmail.com"}),
                new FriendEmailWrapper(new FriendEmail{Email="levon350369@yandex.ru"})
            };
        }
        ...
        public void ShouldTrackAddedItems()
        {
            ...
            var c = new ChangeTrackingCollections<FriendEmailWrapper>(_emails);
        ...
        public void ShouldTrackModifiedItem()
        {
            ...
            emailToModify.Email = "levon.ecs@gmail.com";
            Assert.AreEqual(0, c.AddedItems.Count);
            Assert.AreEqual(0, c.ModifiedItems.Count);
            Assert.AreEqual(0, c.RemovedItems.Count);
            Assert.IsFalse(c.IsChanged);
        ...
        public void ShouldAcceptChanges()
        {
            ...
            c.Remove(emailToRemove);
            emailToModify.Email = "modified@thomasclaudiushuber.com";
            Assert.AreEqual("levon.ecs@gmail.com", emailToModify.EmailOriginalValue);
        ...
        public void ShouldRejectChanges()
        {
            ...
            Assert.IsFalse(emailToModify.IsChanged);
            Assert.AreEqual("levon.ecs@gmail.com", emailToModify.Email);
            Assert.AreEqual("levon.ecs@gmail.com", emailToModify.EmailOriginalValue);
        ...
        public void ShouldRejectChangesWithModifiedAndRemovedItem()
        {
            ...
            c.Remove(email);
            Assert.AreEqual("levon.ecs@gmail.com", email.EmailOriginalValue);
            ...
            Assert.AreEqual("levon.ecs@gmail.com", email.Email);
            Assert.AreEqual("levon.ecs@gmail.com", email.EmailOriginalValue);
