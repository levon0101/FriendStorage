...
namespace FriendStorage.UI.Wrapper.Tests
{
    ...
    public class BasicTests
    {
        ...
        public void ShouldThrowArgumentNullExceptionIfAddressIsNull()
        {
            ...
            {
                Assert.AreEqual("Address can't be Null", ex.Message);
                throw;
            }
        }
        ...
        [TestMethod()]
        public void ShouldSetValuOfUnderlyningModelProperty()
        {
            var wrapper = new FriendWrapper(_friend);
            wrapper.FirstName = "Yalla";
            Assert.AreEqual("Yalla",_friend .FirstName);
        }
    }
}