...
{
    public class ChangeTrackingCollections<T> : ObservableCollection<T>, IRevertibleChangeTracking
        where T : class, IRevertibleChangeTracking, INotifyPropertyChanged
    {
        ...
        public ChangeTrackingCollections(IEnumerable<T> items) : base(items)
        {
